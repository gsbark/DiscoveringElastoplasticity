...
@wp.func
def ST_update_NN(L_n:wp.mat33f,
                 E_n:wp.mat33f,
                 tau_n:wp.mat33f,
                 F_val:wp.float32,
                 F_max:wp.float32,
...
# Stress update for perfect plasticity
@wp.func
def ST_update(L_n:wp.mat33f,
              E_n:wp.mat33f,
              mu:wp.float32,
              K:wp.float32,
              dt:wp.float32):
...
# Stress update for hardening/softening
@wp.func
def ST_update_hardening(L_n:wp.mat33f,
                        E_n:wp.mat33f,
                        lamda_n:wp.float32,
                        mu:wp.float32,
                        K:wp.float32,
...
@wp.func
def ST_update_NN_hardening(L_n:wp.mat33f,
                           E_n:wp.mat33f,
                           tau_n:wp.mat33f,
                           lamda_n:wp.float32,
                           F_val:wp.float32,
